(function (window) {
  ...
  krilloudSDK.setVar = function (tagVar, objectId, value) {
	...
	krilloudSDK.getChannelCount = function () {
    const module = {
      action: function () {
          return js_wrapped_EX_GetChannelCount();
        }
    };
    manageRequest(module);
  };

	krilloudSDK.getChannelVolume = function (channelId) {
    const module = {
			channelId: channelId,
      action: function () {
          return js_wrapped_EX_GetChannelVolume(channelId);
        }
    };
    manageRequest(module);
  };
    ...
    const module = {
      ...
      action: function () {
          return js_wrapped_EX_GetChannelVolumeByName(channelName);
        }
    };
    manageRequest(module);
  };
